var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="css/theme-default.css"><img src="/assets/default.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-forest.css"><img src="/assets/forest.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-dark.css"><img src="/assets/dark.jpg"/></a>'                        
            +'<a href="#" data-theme="css/theme-night.css"><img src="/assets/night.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-serenity.css"><img src="/assets/serenity.jpg"/></a>'
            
            +'<a href="#" data-theme="css/theme-default-head-light.css"><img src="/assets/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-forest-head-light.css"><img src="/assets/forest-head-light.jpg"/></a>'    
            +'<a href="#" data-theme="css/theme-dark-head-light.css"><img src="/assets/dark-head-light.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-night-head-light.css"><img src="/assets/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-serenity-head-light.css"><img src="/assets/serenity-head-light.jpg"/></a>'

        +'</div>'
        +'<div id="ts-wallpapers">'
        +'<div class="ts-title">Wallpapers</div>'
            +'<div class="ts-themes">'
                +'<a href="#" class="active" data-wall="wall_1"><img src="/assets/wall_1.jpg"/></a>'
                +'<a href="#" data-wall="wall_2"><img src="/assets/wall_2.jpg"/></a>'
                +'<a href="#" data-wall="wall_3"><img src="/assets/wall_3.jpg"/></a>'
                +'<a href="#" data-wall="wall_4"><img src="/assets/wall_4.jpg"/></a>'    
                +'<a href="#" data-wall="wall_5"><img src="/assets/wall_5.jpg"/></a>'

                +'<a href="#" data-wall="wall_6"><img src="/assets/wall_6.jpg"/></a>'
                +'<a href="#" data-wall="wall_7"><img src="/assets/wall_7.jpg"/></a>'
                +'<a href="#" data-wall="wall_8"><img src="/assets/wall_8.jpg"/></a>'
                +'<a href="#" data-wall="wall_9"><img src="/assets/wall_9.jpg"/></a>'    
                +'<a href="#" data-wall="wall_10"><img src="/assets/wall_10.jpg"/></a>'    
            +'</div>'
        +'</div>'
    +'</div>';
